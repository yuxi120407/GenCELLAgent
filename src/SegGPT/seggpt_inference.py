...
if __name__ == '__main__':
    ...
    if args.input_image is not None:
        ...
        mask_path = os.path.join(args.output_dir, "output_mask" + '.'.join(img_name.split('.')[:-1]) + '.png')
        inference_image(model, device, args.input_image, args.prompt_image, args.prompt_target, out_path, mask_path)
