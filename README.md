...
That's it! No Google Cloud project, no Vertex AI, no service account JSON needed.[![API Key Setup Tutorial](https://img.youtube.com/vi/YOUR_VIDEO_ID/0.j
  pg)](https://youtu.be/YOUR_VIDEO_ID)  
